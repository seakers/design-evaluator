...
; CHANGE THIS TO ONLY ASSERT THE SMAP ORBITS
...
;   (instruments $?payload))
;    =>
;    ;(duplicate ?orig (in-orbit LEO-600-polar-NA) (orbit-altitude# 600) (orbit-type LEO) (orbit-RAAN NA) (orbit-inclination polar))
;    ;(duplicate ?orig (in-orbit SSO-600-SSO-DD) (orbit-altitude# 600) (orbit-type SSO) (orbit-RAAN DD) (orbit-inclination SSO))
;    ;(duplicate ?orig (in-orbit SSO-600-SSO-AM) (orbit-altitude# 600) (orbit-type SSO) (orbit-RAAN AM) (orbit-inclination SSO))
;    ;(duplicate ?orig (in-orbit SSO-800-SSO-DD) (orbit-altitude# 800) (orbit-type SSO) (orbit-RAAN DD) (orbit-inclination SSO))
;    ;(duplicate ?orig (in-orbit SSO-800-SSO-AM) (orbit-altitude# 800) (orbit-type SSO) (orbit-RAAN AM) (orbit-inclination SSO))
;    (duplicate ?orig (in-orbit LEO-600-polar-NA) (orbit-altitude# 600) (orbit-type LEO) (orbit-RAAN NA) (orbit-inclination polar) (orbit-string LEO-600-polar-NA) (num-of-planes# 1) (num-of-sats-per-plane# 1) (mission-architecture single_arch) (orbit-eccentricity 0))
;    (duplicate ?orig (in-orbit SSO-600-SSO-DD) (orbit-altitude# 600) (orbit-type SSO) (orbit-RAAN DD) (orbit-inclination SSO) (orbit-string SSO-600-SSO-DD) (num-of-planes# 1) (num-of-sats-per-plane# 1) (mission-architecture single_arch) (orbit-eccentricity 0))
;    (duplicate ?orig (in-orbit SSO-600-SSO-AM) (orbit-altitude# 600) (orbit-type SSO) (orbit-RAAN AM) (orbit-inclination SSO) (orbit-string SSO-600-SSO-AM) (num-of-planes# 1) (num-of-sats-per-plane# 1) (mission-architecture single_arch) (orbit-eccentricity 0))
;    (duplicate ?orig (in-orbit SSO-800-SSO-DD) (orbit-altitude# 800) (orbit-type SSO) (orbit-RAAN DD) (orbit-inclination SSO) (orbit-string SSO-800-SSO-DD) (num-of-planes# 1) (num-of-sats-per-plane# 1) (mission-architecture single_arch) (orbit-eccentricity 0))
;    (duplicate ?orig (in-orbit SSO-800-SSO-AM) (orbit-altitude# 800) (orbit-type SSO) (orbit-RAAN AM) (orbit-inclination SSO) (orbit-string SSO-800-SSO-AM) (num-of-planes# 1) (num-of-sats-per-plane# 1) (mission-architecture single_arch) (orbit-eccentricity 0))
;    (duplicate ?orig (in-orbit SSO-500-SSO-PM) (orbit-altitude# 500) (orbit-type SSO) (orbit-RAAN PM) (orbit-inclination SSO) (orbit-string SSO-500-SSO-PM) (num-of-planes# 1) (num-of-sats-per-plane# 1) (mission-architecture single_arch) (orbit-eccentricity 0))
;    (duplicate ?orig (in-orbit SSO-700-SSO-PM) (orbit-altitude# 700) (orbit-type SSO) (orbit-RAAN PM) (orbit-inclination SSO) (orbit-string SSO-700-SSO-PM) (num-of-planes# 1) (num-of-sats-per-plane# 1) (mission-architecture single_arch) (orbit-eccentricity 0))
;    (retract ?orig)
;)
